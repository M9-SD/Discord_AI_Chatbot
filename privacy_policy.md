...
For the purposes of this Privacy Policy:
    ...
    Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to AI Chatbot Bot.
    ...
    Website refers to AI Chatbot Bot
...
What information do we collect when users interact with AI Chatbot?

We start saving the public unique identifier (short: ID) of a Discord server as soon as a permitted user changes any configurable server-related setting (for example the prefix that is used to command AI Chatbot) to further guarantee data persistence of the said changed setting.
...
By using our service (AI Chatbot the Discord bot) you agree to the above-stated policy. Non-agreement forces you to not use our provided service.
